...
The ScannerInput code is here and the class structure is:



There are no changes required in this class; just add it to
 your project, into your utils package. Refer to Topic05
 materials for details on the ScannerInput, should you need
  more info.
 */
package utils;
